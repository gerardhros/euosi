...
```{r example FI1, out.width="75%", fig.cap="Evaluation P-indicator for Latvia.",fig.height = 2,dpi=300, echo = FALSE}
...
```{r example SE1, out.width="75%", fig.cap="Evaluation P-indicator for Norway.",fig.height = 2,dpi=300, echo = FALSE}
