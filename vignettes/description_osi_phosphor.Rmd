...
# show plot
osi_plot_shi(shi = dt$osi_c_p, xpar = dt$A_P_CC, xpar_label = 'P-CaCl2',pgroup = dt$landuse)
...
# show plot
osi_plot_shi(shi = dt$osi_c_p, xpar = dt$A_P_AL, xpar_label = 'P-AL',pgroup = dt$landuse)
