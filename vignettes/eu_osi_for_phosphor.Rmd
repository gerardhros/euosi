...
Two examples are given, one for potato (3301090400), one for maize (3301030000) and one for grassland (3301090205). The optimum soil P threshold is around 60 mg P/kg and actually not different between both land uses. P deficiency symptoms start to occur when the P-CAL becomes lower than 30 mg P/kg.
