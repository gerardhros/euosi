...
Below an example is visualized how the soil health index varies in relation to variation in P-OL. The optimum soil P threshold value for sustainable crop production is around 18 mg P/ kg, and the soil index decreases when P-DL values decreases down to 10 mg P/kg. There is no differntiation among soil types of land uses.
