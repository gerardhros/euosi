...
vignette: >
  %\VignetteIndexEntry{EU OSI introduction}
...
```{r setup, include=FALSE}
  ...
  # require packages
  require(data.table);require(euosi);require(ggplot2)
  # settings
  knitr::opts_chunk$set(echo = TRUE)
  options(rmarkdown.html_vignette.check_title = FALSE)
  setDTthreads(1)
  
  # run manually (set to TRUE)
  if(FALSE){devtools::load_all()}
```
...
More information on the input and ouput variables are documented in a separate vignette `vignette("osi variables")`.
